...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        meetings = []
        room_names = ['Conference Room A', 'Meeting Room B', 'Board Room', 'Virtual Room', 'Collaboration Space']
        for _ in range(25):
        ...
        cost_types = ['Catering', 'Equipment Rental', 'Travel Expenses', 'Materials', 'External Consultant']
